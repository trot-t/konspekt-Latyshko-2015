...
%  \draw[->] (4.75,3.5)--(4.75,4);
  ...
  (7.6,8.5)--(8.0,8.9);
  %мотор  
%  \draw (10,3.5)--(10,1.5)to[short](10,0) (10,1.25)node[component]{M};
%  \draw[ultra thick] (10,3.5)to[short](10,1.5)to[Telmech](10,0);
  \draw (10,3.5)--(10,1.5)to[short](10,0) (10,1.75)node[component]{M}; % на всякий случай
...
%  \draw(0.5,-1.1) to[elmech] (0.5,-0.1);
  \draw(0.5,-1.1) to[Telmech] (0.5,-0.1);
  \end{tikzpicture}
  \hspace{2cm}
  \begin{tikzpicture}
